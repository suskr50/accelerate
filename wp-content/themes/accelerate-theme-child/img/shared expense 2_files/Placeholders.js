...
var Placeholders = (function() {
    ...
    function init(live) {
        ...
        var test = document.createElement("input"), styleElem, styleRules, i, j;
...
//            alert("html5 NOT supported");
    ...
    function createPlaceholders() {
        ...
        var inputs = document.getElementsByTagName("input"), textareas = document.getElementsByTagName("textarea"), numInputs = inputs.length, num = numInputs + textareas.length, i, element, form, placeholder;
...
//                                };
//
//                                // chad - changed this to the format above. this did not work for IE8
...
//                            }
    ...
    function updatePlaceholders() {
        ...
        if (typeof test.placeholder !== "undefined") {
            /* Don't do anything if placeholder is natively supported */
            return;
        }

        //Declare variables, get references to all input and textarea elements
        var inputs = document.getElementsByTagName("input"), textareas = document.getElementsByTagName("textarea"), numInputs = inputs.length, num = numInputs + textareas.length, i, element, oldPlaceholder, newPlaceholder;
    ...
    function submitHandler(elem) {
        var inputs = elem.getElementsByTagName("input"), textareas = elem.getElementsByTagName("textarea"), numInputs = inputs.length, num = numInputs + textareas.length, element, placeholder, i;
    ...
    return {
        ...
        valNonPlaceholder: function(elem) {
